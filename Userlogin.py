...
class Login:
    ...
    # WIDGET FUNCTION
    def obj(self):
        self.loginframe=LabelFrame(self.loginw,bg="#01086b",height=400,width=300)
        self.loginw.bind('<Return>',self.checkuser)
        self.loginframe.place(x=103,y=95)
        self.toplabel = Label(self.loginframe, fg="white", bg="#01086b", anchor="center", text="Login", font="Roboto 40 bold")
        ...
        self.signin = Button(self.loginframe,width=20, text="Sign in",bg="lightblue2",fg="black",command=self.checkuser,font="Roboto 14")
