...
class Main(Login,Admin,User):
    ...
    def buildmain(self):
        ...
        self.topframe=LabelFrame(self.mainw,width=1400,height=120,bg="#01086b")
        self.topframe.place(x=0,y=0)
        self.store_name = ''
        self.storelable=Label(self.topframe,text=self.store_name + "Inventory Management System",bg="#01086b",anchor="center")
        ...
        ''''
        if self.account_type == 'ADMIN':
            self.adminlabel= Label(self.topframe,text="Admin",font="Roboto 10 bold",bg="#01086b")
        else:
            self.adminlabel = Label(self.topframe, text=" User", font="Roboto 10 bold", bg="#01086b")
